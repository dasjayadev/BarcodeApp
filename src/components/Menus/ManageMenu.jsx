            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-full border-2 border-dashed border-orange-300 rounded-lg p-4 text-center cursor-pointer hover:bg-orange-50"
                    ...
                    <p className="text-xs text-gray-400 mt-2 flex justify-between w-full">
